...
{
    public partial class dingwei : Form
    {
        #region //图形显示参数变量
        ...
        private void DealData(UDPData data)
        {
            ...
            //});
                   int a = dgData.Rows.Count - 1;

                if (dgData.Rows[a].Cells[2].Value.ToString() == "02F7" )
                {
                    ucPoint.Location = new Point(130, 130);
                }

                if (dgData.Rows[a].Cells[2].Value.ToString() == "02CD")
                {
                    ucPoint.Location = new Point(340, 130);
                }
                if (dgData.Rows[a].Cells[2].Value.ToString() == "02FD")
                {
                    ucPoint.Location = new Point(130, 280);
                }
                if (dgData.Rows[a].Cells[2].Value.ToString() == "02FA")
                {
                    ucPoint.Location = new Point(340, 280);
                }
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            if (dgData.Rows[a].Cells[2].Value.ToString() == "02CD" || dgData.Rows[a].Cells[2].Value.ToString() == "02FA")
            {
                textBox1.Text = "足球场";
            }

            if (dgData.Rows[a].Cells[2].Value.ToString() == "02FD" || dgData.Rows[a].Cells[2].Value.ToString() == "02F7")
            {
                textBox1.Text = "篮球场";

            }
            if (dgData.CurrentRow.Cells[1].Value.ToString() == "3B1036")
            {
                textBox2.Text = "D2014001";
            }
            if (dgData.CurrentRow.Cells[1].Value.ToString() == "3B1009")
            {
                textBox2.Text = "D2014002";
            }
            else textBox2.Text = "D2014003";

            textBox3.Text = dgData.Rows[0].Cells[8].Value.ToString();
            textBox4.Text = dgData.Rows[a].Cells[8].Value.ToString();
            string sql = "select name from stu where  studentid = '" + textBox2.Text.Trim() + "'";
        ...
        {
            string strSql = "insert into play(studentid,place,begintime,finishtime) values('" + textBox2.Text.Trim().ToString() + "','" + textBox1.Text.Trim().ToString() + "','" + textBox3.Text.Trim().ToString() + "','" + textBox4.Text.Trim().ToString() + "')";
        ...
        {
            Process.Start(Application.StartupPath + "\\定位器接收器配置软件\\TCPIP-232-V4.2.2.exe");
        }
